...
export default function MaskPath() {

    const test = () => {
        var canvas = new fabric.Canvas('canvas');

var maskPath = new fabric.Path('M 10 10 L 90 90');
...
var image = new fabric.Image.fromURL('https://cdn.pixabay.com/photo/2023/01/22/14/10/dinner-7736494_640.jpg', function(img) {
    console.log("img",img);
  img.set({
    left: 0,
    top: 0,
